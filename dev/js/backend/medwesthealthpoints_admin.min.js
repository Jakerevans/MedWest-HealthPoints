...
jQuery( document ).ready( function( $ ) {
	...
	// Function to completely delete a User...
	function medWestDeleteUsers(){
		$( document ).on( 'click', '.medwesthealthpoints-form-section-fields-input-button-delete', function( event ) {
			var newIdRef = $(this).next();
			 // Get Auto Height
		...
		$( document ).on( 'click', '.medwesthealthpoints-form-section-fields-input-button-delete-actual', function( event ) {

			var useridnumber = $( this ).attr( 'data-useridnumber' );
			var activitywpuserid = $( this ).attr( 'data-activitywpuserid' );

			var data = {
	          'action': 'medwesthealthpoints_delete_user_action',
	          'security': medwestHealthpointsPhpVariables.adminnonce20,
